...
(function () {
  ...
  // on Windows a file that was just written moments earlier (e.g. by an
  // antivirus/indexer scan, or a OneDrive/Drive sync placeholder still
  // materializing) can throw NotReadableError/NotAllowedError transiently
  // even though the file is fine a few hundred ms later.
