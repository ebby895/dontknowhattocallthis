...
(function () {
  ...
  const CODE_PATTERNS = [
    /\bcode[:\s]+([A-Z0-9]{5,15})\b/i,
    /\bpromo\s*code[:\s]+([A-Z0-9]{5,15})\b/i,
    /\bcoupon[:\s]+([A-Z0-9]{5,15})\b/i,
    /\buse[:\s]+([A-Z0-9]{5,15})\s+at\s+checkout\b/i,
    /\bclip[^.]{0,20}\bcode[:\s]+([A-Z0-9]{5,15})\b/i
  ];
